...
3. Created `unified-digest-themes` skill as canonical theme source for all digest jobs
4. Submitted PR #22 to agent-skills repo
...
- Theme definitions should live in a shared canonical skill (unified-digest-themes), not duplicated inline in each digest skill
