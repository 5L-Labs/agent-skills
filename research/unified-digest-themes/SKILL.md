...
This skill lives upstream at `5L-hermes01/agent-skills` in the `research/unified-digest-themes/` directory (PR #22 merged 2026-05-22). Changes to this skill should be contributed back to that repo to keep cross-agent consistency.

## Version History

- 1.1.0 (2026-05-22): Author updated to Hermes Agent 01. Provenance note added.
