...
description: Canonical cross-platform theme taxonomy for all digest skills (HN Brief, X-Digest, AI-News, arXiv) and the jargon classification skill. Single source of truth — update here, propagate everywhere.
version: 1.0.0
author: Hermes Agent
license: MIT
metadata:
  hermes:
    tags: [themes, taxonomy, digest, cross-platform, jargon]
